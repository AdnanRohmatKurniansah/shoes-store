...
<div class="row justify-content-center" style="margin-top: 120px">
    <div class="col-lg-4">
        <main class="form-registration">
            ...
            <form action="/klien/klienRegister" method="post">
                @csrf
              ...
              <div class="form-floating">
                <input type="email" class="form-control @error('email') is-invalid @enderror" name="email" name="email" id="email" placeholder="name@example.com" required value="{{ old('email') }}">
            ...
            <small class="d-block text-center mt-3">Already Registered? <a href="/klien/klienLogin" class="text-decoration-none ">Login Now!</a></small>
          </main>
    </div>
</div>
